...
import com.smartlife.qintin.activity.NetItemChangeActivity;
import com.smartlife.qintin.activity.PlaylistActivity;
import com.smartlife.qintin.activity.RadioDetailActivity;
import com.smartlife.qintin.fragment.AttachFragment;
import com.smartlife.qintin.json.RecommendListNewAlbumInfo;
import com.smartlife.qintin.json.RecommendListRadioInfo;
import com.smartlife.qintin.json.RecommendListRecommendInfo;
...
public class RecommendFragment extends AttachFragment {
    ...
    private View mLoadView, v1, v2, v3,v4,v5,v6,v7,v8,v9,v10,v11,v12,v13,v14,v15,v16,v17,v18;
    ...
    private void reloadAdapter() {
        new AsyncTask<Void, Void, Void>() {
            ...
            protected void onPostExecute(Void v) {
                ...
                mViewHashMap.put("主播", v2);
                mViewHashMap.put("头条", v3);
                mViewHashMap.put("相声小品", v4);
                mViewHashMap.put("音乐", v5);
                mViewHashMap.put("搞笑", v6);
                mViewHashMap.put("影视", v7);
                mViewHashMap.put("儿童", v8);
                mViewHashMap.put("体育", v9);
                mViewHashMap.put("评书", v10);
                mViewHashMap.put("戏曲", v11);
                mViewHashMap.put("广播剧", v12);
                mViewHashMap.put("游戏动漫", v13);
                mViewHashMap.put("品牌电台", v14);
                mViewHashMap.put("自媒体", v15);
                mViewHashMap.put("校园", v16);
                mViewHashMap.put("时尚", v17);
                mViewHashMap.put("中国之声", v18);
