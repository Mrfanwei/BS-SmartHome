...
package com.smartlife.qintin.provider;
...
import com.smartlife.qintin.service.MusicTrack;
...
public class MusicPlaybackState {
    private String TAG = "SmartLifee/MusicPS";
    ...
    public void onCreate(final SQLiteDatabase db) {
        ...
        builder.append(PlaybackQueueColumns.TRACK_URL);
    ...
    public synchronized void Insert(MusicTrack track) {
        ...
        try {
            ...
            values.put(PlaybackQueueColumns.TRACK_URL, track.mUrl);
    ...
    public ArrayList<MusicTrack> getQueue() {
        ...
        try {
            ...
            if (cursor != null && cursor.moveToFirst()) {
                ...
                do {
                    results.add(new MusicTrack(cursor.getString(0),cursor.getLong(1), cursor.getInt(2)));
