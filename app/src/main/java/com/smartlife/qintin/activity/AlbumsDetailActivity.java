...
import com.smartlife.qintin.json.AlbumInfo;
...
import com.smartlife.qintin.net.MusicDetailInfoGet;
        ...
        protected Boolean doInBackground(final Void... unused) {
            try {
                ...
                for (int i = 0; i < musicCount; i++) {
                    DianBoProgram.DataBean geDanGeInfo = MainApplication.gsonInstance().fromJson(pArray.get(i), DianBoProgram.DataBean.class);
                    mList.add(geDanGeInfo);
                    RequestThreadPool.post(new MusicDetailInfoGet("1", i, sparseArray));
                }
                ...
                if(sparseArray.size() == musicCount){
                    for (int i = 0; i < mList.size(); i++) {
                        ...
                        musicInfo.songId = Integer.parseInt("1");
                        ...
                        musicInfo.albumId = Integer.parseInt("1");
