...
import com.smartlife.qintin.widget.DragSortRecycler;
...
public class NetItemChangeActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        defaultPosition.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PreferencesUtility.getInstance(NetItemChangeActivity.this).setItemPostion("小说 主播 头条 相声小品 音乐 搞笑 影视 儿童 体育 评书 戏曲 广播剧 游戏动漫 品牌电台 自媒体 校园 时尚 中国之声");
            }
        });
