package com.smartlife.qintin.dialog;
...
import com.smartlife.qintin.downmusic.DownService;
import com.smartlife.qintin.model.DianBoProgram;
import com.smartlife.qintin.json.MusicFileDownInfo;
import com.smartlife.qintin.net.MusicFileDownInfoGet;
import com.smartlife.qintin.net.RequestThreadPool;
...
public class LoadAllDownInfos extends AsyncTask<Void, Void, Boolean> {
    ...
    private ArrayList<DianBoProgram.DataBean> mList = new ArrayList<DianBoProgram.DataBean>();
    private PopupWindow popupWindow;
    private int totalSize;
    private ArrayList<String> mUrlList = new ArrayList<>();
    SparseArray<MusicFileDownInfo> mDownInfoArray = new SparseArray<>();

    public LoadAllDownInfos(Activity context, ArrayList<DianBoProgram.DataBean> list) {
        mContext = context;
        mList = list;
    }
    ...
    protected Boolean doInBackground(Void... params) {
        ...
        try {
            ...
            for (int i = 0; i < le; i++) {
                RequestThreadPool.post(new MusicFileDownInfoGet("1", i, mDownInfoArray, downloadBit));
            }
            int tryCount = 0;
