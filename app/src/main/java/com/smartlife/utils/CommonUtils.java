...
import com.smartlife.qintin.uitl.BuildProperties;
...
public class CommonUtils {
    ...
    public static boolean sendTextMail(String title ,String content)
    {
        try
        {
            ...
            transport.connect("smtp.163.com", 25, "mr_fanwei@163.com",
                    "remusiclog1");
            Message mailMessage = new SMTPMessage(session);
            Address from = new InternetAddress("mr_fanwei@163.com");
            mailMessage.setFrom(from);
            Address to = new InternetAddress("mr_fanwei@163.com");
