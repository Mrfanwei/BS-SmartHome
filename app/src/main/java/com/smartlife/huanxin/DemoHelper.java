...
import com.smartlife.huanxin.db.DemoDBManager;
import com.smartlife.huanxin.db.InviteMessgeDao;
import com.smartlife.huanxin.db.UserDao;
import com.smartlife.huanxin.domain.EaseUser;
import com.smartlife.huanxin.domain.InviteMessage;
import com.smartlife.huanxin.domain.RobotUser;
import com.smartlife.huanxin.utils.EaseCommonUtils;
import com.smartlife.huanxin.utils.PreferenceManager;
...
public class DemoHelper {
    ...
    private String TAG = "SmartLife/DemoHelper";
    /**
     * data sync listener
     */
...
//    }
    ...
    protected void setGlobalListeners(){
        ...
        connectionListener = new EMConnectionListener() {
            ...
            public void onDisconnected(int error) {
                Log.d(TAG,"EMConnectionListener onDisconnected");
                if (error == EMError.USER_REMOVED) {
                    Log.d(TAG, "onUserException: " + "USER_REMOVED");
                    onUserException(Constant.ACCOUNT_REMOVED);
                } else if (error == EMError.USER_LOGIN_ANOTHER_DEVICE) {
                    Log.d(TAG, "onUserException: " + "USER_LOGIN_ANOTHER_DEVICE");
                    onUserException(Constant.ACCOUNT_CONFLICT);
                } else if (error == EMError.SERVER_SERVICE_RESTRICTED) {
                    Log.d(TAG, "onUserException: " + "SERVER_SERVICE_RESTRICTED");
            ...
            public void onConnected() {
                Log.d(TAG,"EMConnectionListener onConnected");
                // in case group and contact were already synced, we supposed to notify sdk we are ready to receive the events
                if (isGroupsSyncedWithServer && isContactsSyncedWithServer) {
                    Log.d(TAG, "group and contact already synced with servre");
                } else {
    ...
    protected void onUserException(String exception){
        Log.d(TAG, "onUserException: " + exception);
