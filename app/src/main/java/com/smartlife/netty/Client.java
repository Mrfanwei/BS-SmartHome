...
public class Client {
    ...
    private static final String TAG = "SmartLife/Client";
        ...
        .addListener(new ChannelFutureListener() {
            ...
            public void operationComplete(ChannelFuture future)
                ...
                if (future.isSuccess()) {
                    ...
                    Log.d(TAG,"Client[{}] connected Gate Successed...");
                } else {
                    Log.d(TAG,"Client[{}] connected Gate Failed");
                }
            }
        });
    }
