package com.smartlife.netty.fragment;
 ...
 */
public class NettyFragment extends DialogFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mLoadView = mLayoutInflater.inflate(R.layout.fragment_netty, container, false);
        mRecyclerView = (RecyclerView) mLoadView.findViewById(R.id.lv_show);
        mLoadView.findViewById(R.id.btn_connect).setOnClickListener(this);
        mLoadView.findViewById(R.id.btn_pause).setOnClickListener(this);
        mLoadView.findViewById(R.id.btn_move).setOnClickListener(this);
        mLoadView.findViewById(R.id.btn_goon).setOnClickListener(this);
        mLoadView.findViewById(R.id.btn_turnleft).setOnClickListener(this);
        mLoadView.findViewById(R.id.btn_turnright).setOnClickListener(this);
        mLoadView.findViewById(R.id.btn_turnup).setOnClickListener(this);
        mLoadView.findViewById(R.id.btn_turndown).setOnClickListener(this);
        mLoadView.findViewById(R.id.btn_collectionlike).setOnClickListener(this);
        ...
        NettyManager.getInstance(getActivity());
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_pause:
                ...
                break;
            case R.id.btn_move:
                NettyManager.getInstance(getActivity()).turnRight();
                break;
            case R.id.btn_goon:
                mDlanManager.goOn("10");
                break;
            case R.id.btn_turnleft:
                NettyManager.getInstance(getActivity()).turnLeft();
                break;
            case R.id.btn_turnright:
                NettyManager.getInstance(getActivity()).turnRight();
                break;
            case R.id.btn_turnup:
                NettyManager.getInstance(getActivity()).turnUp();
                break;
            case R.id.btn_turndown:
                NettyManager.getInstance(getActivity()).turnDown();
                break;
            case R.id.btn_collectionlike:
                NettyManager.getInstance(getActivity()).collectionLike();
                break;
        }
    }
