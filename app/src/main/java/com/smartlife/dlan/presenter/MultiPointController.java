package com.smartlife.dlan.presenter;
...
public class MultiPointController implements IController {
	...
	private static MultiPointController instance;

	public synchronized static MultiPointController getInstance() {
		if (instance == null) {
			instance = new MultiPointController();
		}
		return instance;
	}
